...
__all__ = [ '_AddIns', 'vbextFileTypeGroupProject',
           'vbext_WindowState', 'ReferencesEvents', 'Window',
           'VBProjects', 'vbext_RefKind', '_ReferencesEvents',
           'vbext_ws_Normal', 'vbextFileTypeBinary',
           '_ProjectTemplate', 'CodePane', 'VBComponents',
           'vbext_wt_Watch', 'vbext_wt_LinkedWindowFrame',
           'VBComponent', 'vbext_VBAMode', 'CodeModule',
           'vbext_wt_FindReplace', 'vbextFileTypeExe',
           '_VBProject_Old', '_CodePane', 'SelectedComponents',
           '_dispCommandBarControlEvents', 'vbext_ws_Minimize',
           'vbext_wt_PropertyWindow', 'vbext_wt_Find', 'Events',
           'AddIn', 'vbext_rk_Project', 'vbext_wt_CodeWindow',
           'vbext_cv_FullModuleView', 'Components', 'vbext_vm_Run',
           '_CodePanes', 'CodePanes', '_CommandBarControlEvents',
           'vbext_pk_Let', 'vbextFileTypes', 'vbext_ws_Maximize',
           'vbextFileTypeDocObject', 'vbext_vm_Break', 'Windows',
           'LinkedWindows', 'vbext_rk_TypeLib', 'vbext_wt_Locals',
           'vbext_wt_Immediate', 'vbextFileTypeFrx',
           'ProjectTemplate', 'vbextFileTypeClass',
           'vbext_WindowType', 'vbext_ProjectType',
           'vbext_wt_ToolWindow', '_dispVBComponentsEvents',
           '_VBProjects', 'CommandBarEvents', 'vbextFileTypeProject',
           'vbextFileTypeUserControl', '_VBProject', 'vbext_pk_Get',
           'vbext_ct_ActiveXDesigner', '_References',
           '_LinkedWindows', 'vbext_ct_ClassModule', 'Application',
           '_VBComponents_Old', 'vbext_ct_Document',
           'vbext_wt_Designer', '_VBProjectsEvents',
           'vbext_wt_MainWindow', 'vbext_pk_Set', 'vbextFileTypeRes',
           'Addins', 'Property', '_CodeModule', 'vbext_vm_Design',
           '_VBComponent_Old', 'References', 'VBProject',
           '_Components', 'Component', 'vbext_ct_StdModule',
           'vbextFileTypeForm', 'Properties', 'vbext_pp_none',
           '_VBComponent', '_dispVBProjectsEvents', 'vbext_ct_MSForm',
           'vbextFileTypeDesigners', '_Properties',
           'vbext_ProjectProtection', 'vbext_CodePaneview',
           '_Windows', 'vbext_wt_Toolbox', '_Component',
           'vbext_pt_StandAlone', 'vbext_pt_HostProject',
           '_VBProjects_Old', '_Windows_old', 'vbext_ProcKind',
           'vbext_ComponentType', '_dispReferences_Events',
           'vbext_pp_locked', 'vbext_wt_Browser',
           'vbext_wt_ProjectWindow', '_VBComponentsEvents',
           'vbextFileTypeModule', 'vbextFileTypePropertyPage',
           '_VBComponents', 'VBE', '_dispReferencesEvents',
           'Reference', 'vbext_pk_Proc', 'vbext_cv_ProcedureView']
